...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_example.data');

      };
      Module['addRunDependency']('datafile_example.data');
   ...
   loadPackage({"files": [{"filename": "/handwriting-ja.model", "start": 0, "end": 25875980, "audio": 0}], "remote_package_size": 25875980, "package_uuid": "1e88bc1a-9f93-4303-97e3-df08ab1e39a4"});
...
var wasmBinaryFile = 'example.wasm';
